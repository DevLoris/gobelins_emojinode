...
const transform =new Transform({
    ...
    transform(chunk, encoding, callback) {
        contain_emoji = [];
        var username = null;
        //filtre des tweets vides ou étant des RT car duplicat possible de contenu
        if(chunk.retweeted_status === undefined && chunk.text !== undefined) {
            ...
            if(contain_emoji) {
                ...
                username = chunk.user.screen_name;
                this.push(JSON.stringify({ new_emojis: contain_emoji,  username}));
            }
        }
        callback();
    }
